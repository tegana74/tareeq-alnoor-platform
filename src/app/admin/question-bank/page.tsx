  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-sm text-slate-500">إدارة فصول وأسئلة بنك الأسئلة — يمكنك حذف أي جزء</p>
      </div>

      <ChapterForm subjects={subjectOptions} />
            ...
            <div key={chapter.id} className="overflow-hidden rounded-2xl border border-slate-200 bg-white">
              <div className="flex items-center justify-between border-b border-slate-100 bg-slate-50 px-5 py-3">
                ...
                <div className="flex items-center gap-1">
                  ...
                  <ChapterActions chapterId={chapter.id} />
                </div>
              </div>
